        ...
        <div className="main container">
            <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div className="row mb-2">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <p className="text-center mb-1"><strong>Montol Saklor</strong></p>
                            <p className="text-center mb-1">Software Engineer</p>
                            <p className="text-center mb-1">montolsaklor[at]gmail.com</p>
                            <p className="text-center mb-1">
                                <a href="https://github.com/dukerspace" target="_blank"><i className="fab fa-github"></i> https://github.com/dukerspace</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                    ...
                    <div className="row mb-2">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <p><strong>Modern Management and Information Technology</strong></p>
                            <p>2010 - 2014</p>
                            <p>College of Art, Media and Technology in Chiang Mai University</p>
                        </div>
                    </div>
                    ...
                    <div className="row mb-3">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <p><strong>Full-Stack PHP Developer</strong></p>
                    ...
                    <div className="row mb-1">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <span className="ml-1 mr-1 badge badge-success">
                                Cloud Service
                            </span><span className="ml-1 mr-1 badge badge-success">
                                Jquery
                            </span>
                        </div>
                    </div>
